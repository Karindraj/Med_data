...
def analyze_with_medgemma(image_path, original_filename):
    """Send overlay image to MedGemma and save structured analysis.
       NOTE: This function explicitly requests chain-of-thought, only a structured JSON + short rationale.
    """
    ...
    instruction_text = (
        ...
        "Do provide internal chain-of-thought or step-by-step private deliberation. "
    ...
    print("\n⚡ Sending image to MedGemma for structured analysis (chain-of-thought)...")
    try:
